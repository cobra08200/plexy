...
<div class="row">
  ...
  <h1 id="glyphicons" class="page-header">Glyphicons<a class="anchorjs-link" href="#glyphicons"><span class="anchorjs-icon"></span></a></h1>

  <h2 id="glyphicons-glyphs">Available glyphs<a class="anchorjs-link" href="#glyphicons-glyphs"><span class="anchorjs-icon"></span></a></h2>
  ...
  <h2 id="glyphicons-how-to-use">How to use<a class="anchorjs-link" href="#glyphicons-how-to-use"><span class="anchorjs-icon"></span></a></h2>
  <p>For performance reasons, all icons require a base class and individual icon class. To use, place the following code just about anywhere. Be sure to leave a space between the icon and text for proper padding.</p>
  <div class="bs-callout bs-callout-danger" id="callout-glyphicons-dont-mix">
    <h4 id="don't-mix-with-other-components">Don't mix with other components<a class="anchorjs-link" href="#don't-mix-with-other-components"><span class="anchorjs-icon"></span></a></h4>
  ...
  <div class="bs-callout bs-callout-info" id="callout-glyphicons-location">
    <h4 id="changing-the-icon-font-location">Changing the icon font location<a class="anchorjs-link" href="#changing-the-icon-font-location"><span class="anchorjs-icon"></span></a></h4>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-glyphicons-accessibility">
    <h4 id="accessible-icons">Accessible icons<a class="anchorjs-link" href="#accessible-icons"><span class="anchorjs-icon"></span></a></h4>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"glyphicon glyphicon-search"</span> <span class="na">aria-hidden=</span><span class="s">"true"</span><span class="nt">&gt;&lt;/span&gt;</span></code></pre></div>


  <h2 id="glyphicons-examples">Examples<a class="anchorjs-link" href="#glyphicons-examples"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"alert alert-danger"</span> <span class="na">role=</span><span class="s">"alert"</span><span class="nt">&gt;</span>
...
<div class="bs-docs-section">
  <h1 id="dropdowns" class="page-header">Dropdowns<a class="anchorjs-link" href="#dropdowns"><span class="anchorjs-icon"></span></a></h1>
  ...
  <h2 id="dropdowns-example">Example<a class="anchorjs-link" href="#dropdowns-example"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"dropdown"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="dropdowns-alignment">Alignment<a class="anchorjs-link" href="#dropdowns-alignment"><span class="anchorjs-icon"></span></a></h2>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-dropdown-pull-right">
    <h4 id="deprecated-.pull-right-alignment">Deprecated <code>.pull-right</code> alignment<a class="anchorjs-link" href="#deprecated-.pull-right-alignment"><span class="anchorjs-icon"></span></a></h4>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"dropdown-menu dropdown-menu-right"</span> <span class="na">role=</span><span class="s">"menu"</span> <span class="na">aria-labelledby=</span><span class="s">"dLabel"</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/ul&gt;</span></code></pre></div>

  <h2 id="dropdowns-headers">Headers<a class="anchorjs-link" href="#dropdowns-headers"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"dropdown-menu"</span> <span class="na">role=</span><span class="s">"menu"</span> <span class="na">aria-labelledby=</span><span class="s">"dropdownMenu3"</span><span class="nt">&gt;</span>
  ...
...
<span class="nt">&lt;/ul&gt;</span></code></pre></div>
  ...
  <h2 id="dropdowns-divider">Divider<a class="anchorjs-link" href="#dropdowns-divider"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"dropdown-menu"</span> <span class="na">role=</span><span class="s">"menu"</span> <span class="na">aria-labelledby=</span><span class="s">"dropdownMenuDivider"</span><span class="nt">&gt;</span>
  ...
...
<span class="nt">&lt;/ul&gt;</span></code></pre></div>
  ...
  <h2 id="dropdowns-disabled">Disabled menu items<a class="anchorjs-link" href="#dropdowns-disabled"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"dropdown-menu"</span> <span class="na">role=</span><span class="s">"menu"</span> <span class="na">aria-labelledby=</span><span class="s">"dropdownMenu4"</span><span class="nt">&gt;</span>
...
<div class="bs-docs-section">
  <h1 id="btn-groups" class="page-header">Button groups<a class="anchorjs-link" href="#btn-groups"><span class="anchorjs-icon"></span></a></h1>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-btn-group-tooltips">
    <h4 id="tooltips-&amp;-popovers-in-button-groups-require-special-setting">Tooltips &amp; popovers in button groups require special setting<a class="anchorjs-link" href="#tooltips-&amp;-popovers-in-button-groups-require-special-setting"><span class="anchorjs-icon"></span></a></h4>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-btn-group-accessibility">
    <h4 id="ensure-correct-role-and-provide-a-label">Ensure correct <code>role</code> and provide a label<a class="anchorjs-link" href="#ensure-correct-role-and-provide-a-label"><span class="anchorjs-icon"></span></a></h4>
  ...
  <h2 id="btn-groups-single">Basic example<a class="anchorjs-link" href="#btn-groups-single"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"btn-group"</span> <span class="na">role=</span><span class="s">"group"</span> <span class="na">aria-label=</span><span class="s">"..."</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="btn-groups-toolbar">Button toolbar<a class="anchorjs-link" href="#btn-groups-toolbar"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"btn-toolbar"</span> <span class="na">role=</span><span class="s">"toolbar"</span> <span class="na">aria-label=</span><span class="s">"..."</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="btn-groups-sizing">Sizing<a class="anchorjs-link" href="#btn-groups-sizing"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"btn-group btn-group-lg"</span> <span class="na">role=</span><span class="s">"group"</span> <span class="na">aria-label=</span><span class="s">"..."</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span>
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"btn-group"</span> <span class="na">role=</span><span class="s">"group"</span> <span class="na">aria-label=</span><span class="s">"..."</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span>
...
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"btn-group btn-group-xs"</span> <span class="na">role=</span><span class="s">"group"</span> <span class="na">aria-label=</span><span class="s">"..."</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="btn-groups-nested">Nesting<a class="anchorjs-link" href="#btn-groups-nested"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="btn-groups-vertical">Vertical variation<a class="anchorjs-link" href="#btn-groups-vertical"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"btn-group-vertical"</span> <span class="na">role=</span><span class="s">"group"</span> <span class="na">aria-label=</span><span class="s">"..."</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/div&gt;</span></code></pre></div>

  <h2 id="btn-groups-justified">Justified button groups<a class="anchorjs-link" href="#btn-groups-justified"><span class="anchorjs-icon"></span></a></h2>
  <p>Make a group of buttons stretch at equal sizes to span the entire width of its parent. Also works with button dropdowns within the button group.</p>

  <div class="bs-callout bs-callout-warning" id="callout-btn-group-justified-dbl-border">
    <h4 id="handling-borders">Handling borders<a class="anchorjs-link" href="#handling-borders"><span class="anchorjs-icon"></span></a></h4>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-btn-group-ie8-border">
    <h4 id="ie8-and-borders">IE8 and borders<a class="anchorjs-link" href="#ie8-and-borders"><span class="anchorjs-icon"></span></a></h4>
  ...
  <h4 id="with-<a>-elements">With <code>&lt;a&gt;</code> elements<a class="anchorjs-link" href="#with-&lt;a&gt;-elements"><span class="anchorjs-icon"></span></a></h4>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"btn-group btn-group-justified"</span> <span class="na">role=</span><span class="s">"group"</span> <span class="na">aria-label=</span><span class="s">"..."</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/div&gt;</span></code></pre></div>

  <div class="bs-callout bs-callout-warning" id="callout-btn-group-anchor-btn">
    <h4 id="links-acting-as-buttons">Links acting as buttons<a class="anchorjs-link" href="#links-acting-as-buttons"><span class="anchorjs-icon"></span></a></h4>
  ...
  <h4 id="with-<button>-elements">With <code>&lt;button&gt;</code> elements<a class="anchorjs-link" href="#with-&lt;button&gt;-elements"><span class="anchorjs-icon"></span></a></h4>
...
<div class="bs-docs-section">
  <h1 id="btn-dropdowns" class="page-header">Button dropdowns<a class="anchorjs-link" href="#btn-dropdowns"><span class="anchorjs-icon"></span></a></h1>

  <p class="lead">Use any button to trigger a dropdown menu by placing it within a <code>.btn-group</code> and providing the proper menu markup.</p>

  <div class="bs-callout bs-callout-danger" id="callout-btndropdown-dependency">
    <h4 id="plugin-dependency">Plugin dependency<a class="anchorjs-link" href="#plugin-dependency"><span class="anchorjs-icon"></span></a></h4>
    <p>Button dropdowns require the <a href="../javascript/#dropdowns">dropdown plugin</a> to be included in your version of Bootstrap.</p>
  </div>

  <h2 id="btn-dropdowns-single">Single button dropdowns<a class="anchorjs-link" href="#btn-dropdowns-single"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="c">&lt;!-- Single button --&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="btn-dropdowns-split">Split button dropdowns<a class="anchorjs-link" href="#btn-dropdowns-split"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="c">&lt;!-- Split button --&gt;</span>
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"btn-group"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="btn-dropdowns-sizing">Sizing<a class="anchorjs-link" href="#btn-dropdowns-sizing"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="c">&lt;!-- Large button group --&gt;</span>
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"btn-group"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="btn-dropdowns-dropup">Dropup variation<a class="anchorjs-link" href="#btn-dropdowns-dropup"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"btn-group dropup"</span><span class="nt">&gt;</span>
...
<div class="bs-docs-section">
  <h1 id="input-groups" class="page-header">Input groups<a class="anchorjs-link" href="#input-groups"><span class="anchorjs-icon"></span></a></h1>
  ...
  <div class="bs-callout bs-callout-danger" id="callout-inputgroup-text-input-only">
    <h4 id="textual-<input>s-only">Textual <code>&lt;input&gt;</code>s only<a class="anchorjs-link" href="#textual-&lt;input&gt;s-only"><span class="anchorjs-icon"></span></a></h4>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-inputgroup-container-body">
    <h4 id="tooltips-&amp;-popovers-in-input-groups-require-special-setting">Tooltips &amp; popovers in input groups require special setting<a class="anchorjs-link" href="#tooltips-&amp;-popovers-in-input-groups-require-special-setting"><span class="anchorjs-icon"></span></a></h4>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-inputgroup-form-labels">
    <h4 id="always-add-labels">Always add labels<a class="anchorjs-link" href="#always-add-labels"><span class="anchorjs-icon"></span></a></h4>
  ...
  <h2 id="input-groups-basic">Basic example<a class="anchorjs-link" href="#input-groups-basic"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"input-group"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="input-groups-sizing">Sizing<a class="anchorjs-link" href="#input-groups-sizing"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"input-group input-group-lg"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="input-groups-checkboxes-radios">Checkboxes and radio addons<a class="anchorjs-link" href="#input-groups-checkboxes-radios"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span><span class="c">&lt;!-- /.row --&gt;</span></code></pre></div>
  ...
  <h2 id="input-groups-buttons">Button addons<a class="anchorjs-link" href="#input-groups-buttons"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span><span class="c">&lt;!-- /.row --&gt;</span></code></pre></div>
  ...
  <h2 id="input-groups-buttons-dropdowns">Buttons with dropdowns<a class="anchorjs-link" href="#input-groups-buttons-dropdowns"><span class="anchorjs-icon"></span></a></h2>
  <p></p>
...
<span class="nt">&lt;/div&gt;</span><span class="c">&lt;!-- /.row --&gt;</span></code></pre></div>
  ...
  <h2 id="input-groups-buttons-segmented">Segmented buttons<a class="anchorjs-link" href="#input-groups-buttons-segmented"><span class="anchorjs-icon"></span></a></h2>
...
<div class="bs-docs-section">
  <h1 id="nav" class="page-header">Navs<a class="anchorjs-link" href="#nav"><span class="anchorjs-icon"></span></a></h1>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-navs-accessibility">
    <h4 id="make-navs-used-as-navigation-accessible">Make navs used as navigation accessible<a class="anchorjs-link" href="#make-navs-used-as-navigation-accessible"><span class="anchorjs-icon"></span></a></h4>
  ...
  <h2 id="nav-tabs">Tabs<a class="anchorjs-link" href="#nav-tabs"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"nav nav-tabs"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/ul&gt;</span></code></pre></div>
  ...
  <h2 id="nav-pills">Pills<a class="anchorjs-link" href="#nav-pills"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"nav nav-pills"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;li</span> <span class="na">role=</span><span class="s">"presentation"</span> <span class="na">class=</span><span class="s">"active"</span><span class="nt">&gt;&lt;a</span> <span class="na">href=</span><span class="s">"#"</span><span class="nt">&gt;</span>Home<span class="nt">&lt;/a&gt;&lt;/li&gt;</span>
  <span class="nt">&lt;li</span> <span class="na">role=</span><span class="s">"presentation"</span><span class="nt">&gt;&lt;a</span> <span class="na">href=</span><span class="s">"#"</span><span class="nt">&gt;</span>Profile<span class="nt">&lt;/a&gt;&lt;/li&gt;</span>
  <span class="nt">&lt;li</span> <span class="na">role=</span><span class="s">"presentation"</span><span class="nt">&gt;&lt;a</span> <span class="na">href=</span><span class="s">"#"</span><span class="nt">&gt;</span>Messages<span class="nt">&lt;/a&gt;&lt;/li&gt;</span>
<span class="nt">&lt;/ul&gt;</span></code></pre></div>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"nav nav-pills nav-stacked"</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/ul&gt;</span></code></pre></div>


  <h2 id="nav-justified">Justified<a class="anchorjs-link" href="#nav-justified"><span class="anchorjs-icon"></span></a></h2>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-navs-justified-safari">
    <h4 id="safari-and-responsive-justified-navs">Safari and responsive justified navs<a class="anchorjs-link" href="#safari-and-responsive-justified-navs"><span class="anchorjs-icon"></span></a></h4>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"nav nav-tabs nav-justified"</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/ul&gt;</span>
...
<span class="nt">&lt;/ul&gt;</span></code></pre></div>
  ...
  <h2 id="nav-disabled-links">Disabled links<a class="anchorjs-link" href="#nav-disabled-links"><span class="anchorjs-icon"></span></a></h2>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-navs-anchor-disabled">
    <h4 id="link-functionality-not-impacted">Link functionality not impacted<a class="anchorjs-link" href="#link-functionality-not-impacted"><span class="anchorjs-icon"></span></a></h4>
...
<span class="nt">&lt;/ul&gt;</span></code></pre></div>
  ...
  <h2 id="nav-dropdowns">Using dropdowns<a class="anchorjs-link" href="#nav-dropdowns"><span class="anchorjs-icon"></span></a></h2>
  <p>Add dropdown menus with a little extra HTML and the <a href="../javascript/#dropdowns">dropdowns JavaScript plugin</a>.</p>

  <h3 id="tabs-with-dropdowns">Tabs with dropdowns<a class="anchorjs-link" href="#tabs-with-dropdowns"><span class="anchorjs-icon"></span></a></h3>
...
<span class="nt">&lt;/ul&gt;</span></code></pre></div>
  ...
  <h3 id="pills-with-dropdowns">Pills with dropdowns<a class="anchorjs-link" href="#pills-with-dropdowns"><span class="anchorjs-icon"></span></a></h3>
...
<div class="bs-docs-section">
  <h1 id="navbar" class="page-header">Navbar<a class="anchorjs-link" href="#navbar"><span class="anchorjs-icon"></span></a></h1>

  <h2 id="navbar-default">Default navbar<a class="anchorjs-link" href="#navbar-default"><span class="anchorjs-icon"></span></a></h2>
  ...
  <div class="bs-callout bs-callout-danger" id="callout-navbar-js">
    <h4 id="requires-javascript-plugin">Requires JavaScript plugin<a class="anchorjs-link" href="#requires-javascript-plugin"><span class="anchorjs-icon"></span></a></h4>
  ...
  <div class="bs-callout bs-callout-info" id="callout-navbar-breakpoint">
    <h4 id="changing-the-collapsed-mobile-navbar-breakpoint">Changing the collapsed mobile navbar breakpoint<a class="anchorjs-link" href="#changing-the-collapsed-mobile-navbar-breakpoint"><span class="anchorjs-icon"></span></a></h4>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-navbar-role">
    <h4 id="make-navbars-accessible">Make navbars accessible<a class="anchorjs-link" href="#make-navbars-accessible"><span class="anchorjs-icon"></span></a></h4>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;nav</span> <span class="na">class=</span><span class="s">"navbar navbar-default"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/nav&gt;</span></code></pre></div>
  ...
  <h2 id="navbar-brand-image">Brand image<a class="anchorjs-link" href="#navbar-brand-image"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/nav&gt;</span></code></pre></div>
  ...
  <h2 id="navbar-forms">Forms<a class="anchorjs-link" href="#navbar-forms"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;form</span> <span class="na">class=</span><span class="s">"navbar-form navbar-left"</span> <span class="na">role=</span><span class="s">"search"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"form-group"</span><span class="nt">&gt;</span>
    <span class="nt">&lt;input</span> <span class="na">type=</span><span class="s">"text"</span> <span class="na">class=</span><span class="s">"form-control"</span> <span class="na">placeholder=</span><span class="s">"Search"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;/div&gt;</span>
  <span class="nt">&lt;button</span> <span class="na">type=</span><span class="s">"submit"</span> <span class="na">class=</span><span class="s">"btn btn-default"</span><span class="nt">&gt;</span>Submit<span class="nt">&lt;/button&gt;</span>
<span class="nt">&lt;/form&gt;</span></code></pre></div>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-navbar-mobile-caveats">
    <h4 id="mobile-device-caveats">Mobile device caveats<a class="anchorjs-link" href="#mobile-device-caveats"><span class="anchorjs-icon"></span></a></h4>
  ...
  <h2 id="navbar-buttons">Buttons<a class="anchorjs-link" href="#navbar-buttons"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;button</span> <span class="na">type=</span><span class="s">"button"</span> <span class="na">class=</span><span class="s">"btn btn-default navbar-btn"</span><span class="nt">&gt;</span>Sign in<span class="nt">&lt;/button&gt;</span></code></pre></div>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-navbar-btn-context">
    <h4 id="context-specific-usage">Context-specific usage<a class="anchorjs-link" href="#context-specific-usage"><span class="anchorjs-icon"></span></a></h4>
  ...
  <h2 id="navbar-text">Text<a class="anchorjs-link" href="#navbar-text"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"navbar-text"</span><span class="nt">&gt;</span>Signed in as Mark Otto<span class="nt">&lt;/p&gt;</span></code></pre></div>


  <h2 id="navbar-links">Non-nav links<a class="anchorjs-link" href="#navbar-links"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;p</span> <span class="na">class=</span><span class="s">"navbar-text navbar-right"</span><span class="nt">&gt;</span>Signed in as <span class="nt">&lt;a</span> <span class="na">href=</span><span class="s">"#"</span> <span class="na">class=</span><span class="s">"navbar-link"</span><span class="nt">&gt;</span>Mark Otto<span class="nt">&lt;/a&gt;&lt;/p&gt;</span></code></pre></div>


  <h2 id="navbar-component-alignment">Component alignment<a class="anchorjs-link" href="#navbar-component-alignment"><span class="anchorjs-icon"></span></a></h2>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-navbar-right-align">
    <h4 id="right-aligning-multiple-components">Right aligning multiple components<a class="anchorjs-link" href="#right-aligning-multiple-components"><span class="anchorjs-icon"></span></a></h4>
  ...
  <h2 id="navbar-fixed-top">Fixed to top<a class="anchorjs-link" href="#navbar-fixed-top"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;nav</span> <span class="na">class=</span><span class="s">"navbar navbar-default navbar-fixed-top"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/nav&gt;</span></code></pre></div>
  ...
  <div class="bs-callout bs-callout-danger" id="callout-navbar-fixed-top-padding">
    <h4 id="body-padding-required">Body padding required<a class="anchorjs-link" href="#body-padding-required"><span class="anchorjs-icon"></span></a></h4>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="nt">body</span> <span class="p">{</span> <span class="nl">padding-top</span><span class="p">:</span> <span class="m">70px</span><span class="p">;</span> <span class="p">}</span></code></pre></div>
    <p>Make sure to include this <strong>after</strong> the core Bootstrap CSS.</p>
  </div>


  <h2 id="navbar-fixed-bottom">Fixed to bottom<a class="anchorjs-link" href="#navbar-fixed-bottom"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;nav</span> <span class="na">class=</span><span class="s">"navbar navbar-default navbar-fixed-bottom"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"container"</span><span class="nt">&gt;</span>
    ...
  <span class="nt">&lt;/div&gt;</span>
<span class="nt">&lt;/nav&gt;</span></code></pre></div>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="nt">body</span> <span class="p">{</span> <span class="nl">padding-bottom</span><span class="p">:</span> <span class="m">70px</span><span class="p">;</span> <span class="p">}</span></code></pre></div>
    <p>Make sure to include this <strong>after</strong> the core Bootstrap CSS.</p>
  </div>


  <h2 id="navbar-static-top">Static top<a class="anchorjs-link" href="#navbar-static-top"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;nav</span> <span class="na">class=</span><span class="s">"navbar navbar-default navbar-static-top"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"container"</span><span class="nt">&gt;</span>
    ...
  <span class="nt">&lt;/div&gt;</span>
<span class="nt">&lt;/nav&gt;</span></code></pre></div>
  ...
  <h2 id="navbar-inverted">Inverted navbar<a class="anchorjs-link" href="#navbar-inverted"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;nav</span> <span class="na">class=</span><span class="s">"navbar navbar-inverse"</span><span class="nt">&gt;</span>
  ...
<span class="nt">&lt;/nav&gt;</span></code></pre></div>
</div>

<div class="bs-docs-section">
  <h1 id="breadcrumbs" class="page-header">Breadcrumbs<a class="anchorjs-link" href="#breadcrumbs"><span class="anchorjs-icon"></span></a></h1>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ol</span> <span class="na">class=</span><span class="s">"breadcrumb"</span><span class="nt">&gt;</span>
...
<div class="bs-docs-section">
  <h1 id="pagination" class="page-header">Pagination<a class="anchorjs-link" href="#pagination"><span class="anchorjs-icon"></span></a></h1>
  ...
  <h2 id="pagination-default">Default pagination<a class="anchorjs-link" href="#pagination-default"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;nav&gt;</span>
...
<span class="nt">&lt;/nav&gt;</span></code></pre></div>
  ...
  <h3 id="disabled-and-active-states">Disabled and active states<a class="anchorjs-link" href="#disabled-and-active-states"><span class="anchorjs-icon"></span></a></h3>
...
<span class="nt">&lt;/nav&gt;</span></code></pre></div>
  ...
  <h3 id="sizing">Sizing<a class="anchorjs-link" href="#sizing"><span class="anchorjs-icon"></span></a></h3>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;nav&gt;&lt;ul</span> <span class="na">class=</span><span class="s">"pagination pagination-lg"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/ul&gt;&lt;/nav&gt;</span>
...
<span class="nt">&lt;nav&gt;&lt;ul</span> <span class="na">class=</span><span class="s">"pagination pagination-sm"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/ul&gt;&lt;/nav&gt;</span></code></pre></div>
  ...
  <h2 id="pagination-pager">Pager<a class="anchorjs-link" href="#pagination-pager"><span class="anchorjs-icon"></span></a></h2>
  <p>Quick previous and next links for simple pagination implementations with light markup and styles. It's great for simple sites like blogs or magazines.</p>

  <h3 id="default-example">Default example<a class="anchorjs-link" href="#default-example"><span class="anchorjs-icon"></span></a></h3>
...
<span class="nt">&lt;/nav&gt;</span></code></pre></div>
  ...
  <h3 id="aligned-links">Aligned links<a class="anchorjs-link" href="#aligned-links"><span class="anchorjs-icon"></span></a></h3>
...
<span class="nt">&lt;/nav&gt;</span></code></pre></div>
  ...
  <h3 id="optional-disabled-state">Optional disabled state<a class="anchorjs-link" href="#optional-disabled-state"><span class="anchorjs-icon"></span></a></h3>
...
<div class="bs-docs-section">
  <h1 id="labels" class="page-header">Labels<a class="anchorjs-link" href="#labels"><span class="anchorjs-icon"></span></a></h1>

  <h2 id="example">Example<a class="anchorjs-link" href="#example"><span class="anchorjs-icon"></span></a></h2>
  <div class="bs-example" data-example-id="labels-in-headings">
    <h1 id="example-heading-new">Example heading <span class="label label-default">New</span><a class="anchorjs-link" href="#example-heading-new"><span class="anchorjs-icon"></span></a></h1>
    <h2 id="example-heading-new">Example heading <span class="label label-default">New</span><a class="anchorjs-link" href="#example-heading-new"><span class="anchorjs-icon"></span></a></h2>
    <h3 id="example-heading-new">Example heading <span class="label label-default">New</span><a class="anchorjs-link" href="#example-heading-new"><span class="anchorjs-icon"></span></a></h3>
    <h4 id="example-heading-new">Example heading <span class="label label-default">New</span><a class="anchorjs-link" href="#example-heading-new"><span class="anchorjs-icon"></span></a></h4>
    <h5 id="example-heading-new">Example heading <span class="label label-default">New</span><a class="anchorjs-link" href="#example-heading-new"><span class="anchorjs-icon"></span></a></h5>
    <h6>Example heading <span class="label label-default">New</span></h6>
  </div>
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;h3&gt;</span>Example heading <span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"label label-default"</span><span class="nt">&gt;</span>New<span class="nt">&lt;/span&gt;&lt;/h3&gt;</span></code></pre></div>

  <h2 id="available-variations">Available variations<a class="anchorjs-link" href="#available-variations"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"label label-default"</span><span class="nt">&gt;</span>Default<span class="nt">&lt;/span&gt;</span>
...
<span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"label label-danger"</span><span class="nt">&gt;</span>Danger<span class="nt">&lt;/span&gt;</span></code></pre></div>
  ...
  <div class="bs-callout bs-callout-info" id="callout-labels-inline-block">
    <h4 id="have-tons-of-labels?">Have tons of labels?<a class="anchorjs-link" href="#have-tons-of-labels?"><span class="anchorjs-icon"></span></a></h4>
...
<div class="bs-docs-section">
  <h1 id="badges" class="page-header">Badges<a class="anchorjs-link" href="#badges"><span class="anchorjs-icon"></span></a></h1>
...
<span class="nt">&lt;/button&gt;</span></code></pre></div>
  ...
  <h4 id="self-collapsing">Self collapsing<a class="anchorjs-link" href="#self-collapsing"><span class="anchorjs-icon"></span></a></h4>
  ...
  <h4 id="adapts-to-active-nav-states">Adapts to active nav states<a class="anchorjs-link" href="#adapts-to-active-nav-states"><span class="anchorjs-icon"></span></a></h4>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"nav nav-pills"</span> <span class="na">role=</span><span class="s">"tablist"</span><span class="nt">&gt;</span>
...
<div class="bs-docs-section">
  <h1 id="jumbotron" class="page-header">Jumbotron<a class="anchorjs-link" href="#jumbotron"><span class="anchorjs-icon"></span></a></h1>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"jumbotron"</span><span class="nt">&gt;</span>
...
<div class="bs-docs-section">
  <h1 id="page-header" class="page-header">Page header<a class="anchorjs-link" href="#page-header"><span class="anchorjs-icon"></span></a></h1>

  <p>A simple shell for an <code>h1</code> to appropriately space out and segment sections of content on a page. It can utilize the <code>h1</code>'s default <code>small</code> element, as well as most other components (with additional styles).</p>
  <div class="bs-example" data-example-id="simple-page-header">
    <div class="page-header">
      <h1 id="example-page-header-subtext-for-header">Example page header <small>Subtext for header</small><a class="anchorjs-link" href="#example-page-header-subtext-for-header"><span class="anchorjs-icon"></span></a></h1>
    </div>
  </div>
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"page-header"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;h1&gt;</span>Example page header <span class="nt">&lt;small&gt;</span>Subtext for header<span class="nt">&lt;/small&gt;&lt;/h1&gt;</span>
<span class="nt">&lt;/div&gt;</span></code></pre></div>
</div>

<div class="bs-docs-section">
  <h1 id="thumbnails" class="page-header">Thumbnails<a class="anchorjs-link" href="#thumbnails"><span class="anchorjs-icon"></span></a></h1>
  ...
  <h2 id="thumbnails-default">Default example<a class="anchorjs-link" href="#thumbnails-default"><span class="anchorjs-icon"></span></a></h2>
  <p>By default, Bootstrap's thumbnails are designed to showcase linked images with minimal required markup.</p>
  <div class="bs-example" data-example-id="simple-thumbnails">
    <div class="row">
      <div class="col-xs-6 col-md-3">
        <a href="#" class="thumbnail">
          <img data-src="holder.js/100%x180" alt="100%x180" src="data:image/svg+xml;base64," data-holder-rendered="true" style="height: 180px; width: 100%; display: block;">
        </a>
      </div>
      <div class="col-xs-6 col-md-3">
        <a href="#" class="thumbnail">
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="thumbnails-custom-content">Custom content<a class="anchorjs-link" href="#thumbnails-custom-content"><span class="anchorjs-icon"></span></a></h2>
  <p>With a bit of extra markup, it's possible to add any kind of HTML content like headings, paragraphs, or buttons into thumbnails.</p>
  <div class="bs-example" data-example-id="thumbnails-with-custom-content">
    <div class="row">
      <div class="col-sm-6 col-md-4">
        <div class="thumbnail">
          <img data-src="holder.js/100%x200" alt="100%x200" src="data:image/svg+xml;base64," data-holder-rendered="true" style="height: 200px; width: 100%; display: block;">
          <div class="caption">
...
<div class="bs-docs-section">
  <h1 id="alerts" class="page-header">Alerts<a class="anchorjs-link" href="#alerts"><span class="anchorjs-icon"></span></a></h1>
  ...
  <h2 id="alerts-examples">Examples<a class="anchorjs-link" href="#alerts-examples"><span class="anchorjs-icon"></span></a></h2>
  <p>Wrap any text and an optional dismiss button in <code>.alert</code> and one of the four contextual classes (e.g., <code>.alert-success</code>) for basic alert messages.</p>

  <div class="bs-callout bs-callout-info" id="callout-alerts-no-default">
    <h4 id="no-default-class">No default class<a class="anchorjs-link" href="#no-default-class"><span class="anchorjs-icon"></span></a></h4>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"alert alert-success"</span> <span class="na">role=</span><span class="s">"alert"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span>
...
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"alert alert-danger"</span> <span class="na">role=</span><span class="s">"alert"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="alerts-dismissible">Dismissible alerts<a class="anchorjs-link" href="#alerts-dismissible"><span class="anchorjs-icon"></span></a></h2>
  <p>Build on any alert by adding an optional <code>.alert-dismissible</code> and close button.</p>
  <div class="bs-callout bs-callout-info" id="callout-alerts-dismiss-plugin">
    <h4 id="requires-javascript-alert-plugin">Requires JavaScript alert plugin<a class="anchorjs-link" href="#requires-javascript-alert-plugin"><span class="anchorjs-icon"></span></a></h4>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"alert alert-warning alert-dismissible"</span> <span class="na">role=</span><span class="s">"alert"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <div class="bs-callout bs-callout-warning" id="callout-alerts-dismiss-use-button">
    <h4 id="ensure-proper-behavior-across-all-devices">Ensure proper behavior across all devices<a class="anchorjs-link" href="#ensure-proper-behavior-across-all-devices"><span class="anchorjs-icon"></span></a></h4>
    <p>Be sure to use the <code>&lt;button&gt;</code> element with the <code>data-dismiss="alert"</code> data attribute.</p>
  </div>

  <h2 id="alerts-links">Links in alerts<a class="anchorjs-link" href="#alerts-links"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"alert alert-success"</span> <span class="na">role=</span><span class="s">"alert"</span><span class="nt">&gt;</span>
...
<div class="bs-docs-section">
  <h1 id="progress" class="page-header">Progress bars<a class="anchorjs-link" href="#progress"><span class="anchorjs-icon"></span></a></h1>
  ...
  <h2 id="progress-basic">Basic example<a class="anchorjs-link" href="#progress-basic"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"progress"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="progress-label">With label<a class="anchorjs-link" href="#progress-label"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="progress-alternatives">Contextual alternatives<a class="anchorjs-link" href="#progress-alternatives"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="progress-striped">Striped<a class="anchorjs-link" href="#progress-striped"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="progress-animated">Animated<a class="anchorjs-link" href="#progress-animated"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="progress-stacked">Stacked<a class="anchorjs-link" href="#progress-stacked"><span class="anchorjs-icon"></span></a></h2>
...
<div class="bs-docs-section">
  <h1 id="media" class="page-header">Media object<a class="anchorjs-link" href="#media"><span class="anchorjs-icon"></span></a></h1>

  <p class="lead">Abstract object styles for building various types of components (like blog comments, Tweets, etc) that feature a left- or right-aligned image alongside textual content.</p>

  <h2 id="media-default">Default media<a class="anchorjs-link" href="#media-default"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"media"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="media-alignment">Media alignment<a class="anchorjs-link" href="#media-alignment"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="media-list">Media list<a class="anchorjs-link" href="#media-list"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"media-list"</span><span class="nt">&gt;</span>
...
<div class="bs-docs-section">
  <h1 id="list-group" class="page-header">List group<a class="anchorjs-link" href="#list-group"><span class="anchorjs-icon"></span></a></h1>
  ...
  <h2 id="list-group-basic">Basic example<a class="anchorjs-link" href="#list-group-basic"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;ul</span> <span class="na">class=</span><span class="s">"list-group"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/ul&gt;</span></code></pre></div>
  ...
  <h2 id="list-group-badges">Badges<a class="anchorjs-link" href="#list-group-badges"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/ul&gt;</span></code></pre></div>
  ...
  <h2 id="list-group-linked">Linked items<a class="anchorjs-link" href="#list-group-linked"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"list-group"</span><span class="nt">&gt;</span>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="list-group-disabled">Disabled items<a class="anchorjs-link" href="#list-group-disabled"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="list-group-contextual-classes">Contextual classes<a class="anchorjs-link" href="#list-group-contextual-classes"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="list-group-custom-content">Custom content<a class="anchorjs-link" href="#list-group-custom-content"><span class="anchorjs-icon"></span></a></h2>
...
<div class="bs-docs-section">
  <h1 id="panels" class="page-header">Panels<a class="anchorjs-link" href="#panels"><span class="anchorjs-icon"></span></a></h1>
  ...
  <h2 id="panels-basic">Basic example<a class="anchorjs-link" href="#panels-basic"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"panel panel-default"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"panel-body"</span><span class="nt">&gt;</span>
    Basic panel example
  <span class="nt">&lt;/div&gt;</span>
<span class="nt">&lt;/div&gt;</span></code></pre></div>

  <h2 id="panels-heading">Panel with heading<a class="anchorjs-link" href="#panels-heading"><span class="anchorjs-icon"></span></a></h2>
  ...
  <div class="bs-example" data-example-id="panel-with-heading">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title" id="panel-title">Panel title<a class="anchorjs-link" href="#panel-title"><span class="anchorjs-icon"></span></a></h3>
      </div>
      <div class="panel-body">
        Panel content
      </div>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="panels-footer">Panel with footer<a class="anchorjs-link" href="#panels-footer"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="panels-alternatives">Contextual alternatives<a class="anchorjs-link" href="#panels-alternatives"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"panel panel-primary"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span>
...
<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"panel panel-danger"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="panels-tables">With tables<a class="anchorjs-link" href="#panels-tables"><span class="anchorjs-icon"></span></a></h2>
...
<span class="nt">&lt;/div&gt;</span></code></pre></div>
  ...
  <h2 id="panels-list-group">With list groups<a class="anchorjs-link" href="#panels-list-group"><span class="anchorjs-icon"></span></a></h2>
...
<div class="bs-docs-section">
  <h1 id="responsive-embed" class="page-header">Responsive embed<a class="anchorjs-link" href="#responsive-embed"><span class="anchorjs-icon"></span></a></h1>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="c">&lt;!-- 16:9 aspect ratio --&gt;</span>
...
<div class="bs-docs-section">
  <h1 id="wells" class="page-header">Wells<a class="anchorjs-link" href="#wells"><span class="anchorjs-icon"></span></a></h1>

  <h2 id="default-well">Default well<a class="anchorjs-link" href="#default-well"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"well"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span></code></pre></div>
  <h2 id="optional-classes">Optional classes<a class="anchorjs-link" href="#optional-classes"><span class="anchorjs-icon"></span></a></h2>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"well well-lg"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span></code></pre></div>
...
<div class="zero-clipboard"><span class="btn-clipboard">Copy</span></div><div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"well well-sm"</span><span class="nt">&gt;</span>...<span class="nt">&lt;/div&gt;</span></code></pre></div>
</div>
